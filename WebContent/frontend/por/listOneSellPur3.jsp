...
<section class='rating-widget'>
  ...
  <div class='success-box'>
    <div class='text-message'></div>
			 							...
			 							<button type="button" data-toggle="modal" data-target="#showbox${s.count}" onclick="Showstar(${porVO.porsellscore})" class="sellscore" value="showbox${s.count}">更改評價</button>
												<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/frontend/por/por" style="margin-bottom: 0px;">
												<div class="modal fade" id="showbox${s.count}" role="dialog">
												<div class="modal-dialog">
												<div class="modal-content">
...
// 		var sc = $('.sellscore').val();
// 		if(a>0){
// 			for(i=1;i<=a;i++){
// 				$('#'+sc+' div.rating-stars text-center ul.stars #star'+i).addClass('selected');
// 			}
// 		}			
// 	}
	$(document).ready(function(){
		...
		function responseMessage(msg) {
		  $('.success-box div.text-message').html("<input type='text' name='porsellscore' value='"+msg+"'>");
		}
