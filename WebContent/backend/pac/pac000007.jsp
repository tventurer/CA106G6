      ...
      <div id="property-carousel" class="owl-carousel owl-theme">
        <div class="carousel-item-b">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="img/Package/pac03/10001.jpg" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="property-single.html">漫步櫻花 北海道函館夜景 尼克斯海洋公園.
                      <br /> 浪漫小樽三大蟹.溫泉美食5日</a>
                  </h2>
                </div>
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a"> $ 45900起</span>
                  </div>
                  <a href="#" class="link-a">觀看詳情
                ...
                <div class="card-footer-a">
                  <ul class="card-info d-flex justify-content-around">
                    ...
                    <li>
                      <h4 class="card-info-title">4/9</h4>
                      <span>45900</span>
                    </li>
                    <li>
                      <h4 class="card-info-title">4/11</h4>
                      <span>46200</span>
                    </li>
                    <li>
                      <h4 class="card-info-title">4/12</h4>
                      <span>46800</span>
                    </li>
                  </ul>
                </div>
        ...
        <div class="carousel-item-b">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="img/Package/pac03/10004.jpg" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="property-single.html">尋訪大江南古鎮
                      <br /> 夜宿烏鎮西柵、宋城千古情秀8日</a>
                  </h2>
                </div>
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">驚爆價 | $ 30900起</span>
                  </div>
                  <a href="property-single.html" class="link-a">觀看詳情
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
                </div>
                <div class="card-footer-a">
                  <ul class="card-info d-flex justify-content-around">
                    ...
                    <li>
                      <h4 class="card-info-title">3/23</h4>
                      <span>30900</span>
                    </li>
                    <li>
                      <h4 class="card-info-title">3/24</h4>
                      <span>32100</span>
                    </li>
                    <li>
                      <h4 class="card-info-title">3/29</h4>
                      <span>31500</span>
                    </li>
                  </ul>
                </div>
        ...
        <div class="carousel-item-b">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="img/Package/pac03/10006.jpg" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="property-single.html">【2019公主遊輪】盛世公主號～沖繩石垣島自由行5天
                      
                  </h2>
                </div>
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">破盤價 | $ 20900起</span>
                  </div>
                  <a href="property-single.html" class="link-a">觀看詳情
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
                ...
                <div class="card-footer-a">
                  <ul class="card-info d-flex justify-content-around">
                    ...
                    <li>
                      <h4 class="card-info-title">5/29</h4>
                      <span>9</span>
                    </li>
                    <li>
                      <h4 class="card-info-title">6/12</h4>
                      <span>15</span>
                    </li>
                    <li>
                      <h4 class="card-info-title">6/23</h4>
                      <span>20900</span>
                    </li>
                  </ul>
                </div>
        ...
        <div class="carousel-item-b">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="img/Package/pac03/10008.jpg" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="property-single.html">
                      【迪士尼玩兩天】河口湖富士山．御殿場OUTLET．東京５日
                    </a>
                  </h2>
                </div>
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">$ 32900 起</span>
                  </div>
                  <a href="property-single.html" class="link-a">觀看詳情
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
                ...
                <div class="card-footer-a">
                  <ul class="card-info d-flex justify-content-around">
                    ...
                    <li>
                      <h4 class="card-info-title">3/30</h4>
                      <span>33000</span>
                    </li>
                    <li>
                      <h4 class="card-info-title">4/1</h4>
                      <span>35800</span>
                    </li>
                    <li>
                      <h4 class="card-info-title">4/2</h4>
                      <span>34000</span>
                    </li>
                  </ul>
                </div>
         ...
         <div class="carousel-item-b">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="img/Package/pac03/10011.jpg" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                  <h2 class="card-title-a">
                    <a href="property-single.html">
                      黑部立山~足利紫藤花祭~上高地祕境~富士芝櫻~4大溫泉五日
                    </a>
                  </h2>
                </div>
                <div class="card-body-a">
                  <div class="price-box d-flex">
                    <span class="price-a">$ 38500 起</span>
                  </div>
                  <a href="property-single.html" class="link-a">觀看詳情
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
                ...
                <div class="card-footer-a">
                  <ul class="card-info d-flex justify-content-around">
                    ...
                    <li>
                      <h4 class="card-info-title">3/31</h4>
                      <span>39800</span>
                    </li>
                    <li>
                      <h4 class="card-info-title">4/10</h4>
                      <span>38500</span>
                    </li>
                    <li>
                      <h4 class="card-info-title">4/18</h4>
                      <span>38500</span>
                    </li>
                  </ul>
                </div>
