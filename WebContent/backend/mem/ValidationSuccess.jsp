      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            <h1 class="title-single">${memVO.memrealname}你好! 您的信箱${memVO.mememail}已經通過驗證!</h1>
            <span class="color-text-a"><a href="<%=request.getContextPath()%>/frontend/mem/MyPage.jsp?memno=${memno}">回個人首頁</a></span>
          </div>
        </div>
      </div>
    </div>
