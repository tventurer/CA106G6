...
<table>
	...
	<tr>
		...
		<td><input type="radio" name="empgen"
			 value="1" ${(empVO.empgen==1)? 'checked' : '' } />男
	...
	<tr>
		...
		<td><input type="text" name="empcell" size="45"
			 value="<%= empVO.getEmpcell()%>" /></td>
	</tr>
	<tr>
		<td>email:</td>
		<td><input type="text" name="empmail" size="45"
			 value="<%= empVO.getEmpmail()%>"/></td>
	</tr>
	<tr>
		<td>部門:</td>
	...
	<tr>
		...
		<td><input type="text" name="empposi" size="45"
			 value="<%= empVO.getEmpposi()%>" /></td>
	</tr>
	<tr>
		<td>薪資:</td>
		<td><input type="text" name="empsal" size="45"
			 value="<%= empVO.getEmpsal()%>" /></td>
	</tr>
	<tr>
		<td>到職日:</td>
