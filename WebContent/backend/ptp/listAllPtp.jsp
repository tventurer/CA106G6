...
<table id="table-1">
	<tr><td>
		 <h3 align="center">所有套裝出團資訊 - listAllPtp.jsp</h3>
...
<table>
	...
	<%@ include file="page1" %> 
	<c:forEach var="ptpVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
<!-- 	begin 後面 跟page1  page2是分頁的東西	 -->
		<tr>
			<td>${ptpVO.ptpno}</td>
			<td>${ptpVO.pacno}</td>
			<td><fmt:formatDate value="${ptpVO.ptpstart}" pattern="yyyy-MM-dd HH:MM"/></td>
