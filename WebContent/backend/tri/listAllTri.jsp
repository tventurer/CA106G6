  ...
  <body class="app sidebar-mini rtl">
   ...
   <jsp:include page="/backend/backbar.jsp"/>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> 顯示所有自由行行程</h1>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-md-12">
          <div class="tile">
            <h3 class="tile-title">所有自由行行程</h3>
            ...
            <table class="table table-hover">
              ...
              <!--處理分頁 -->
                ...
                <tr>
	              ...
	              <td>
	              	<input class="quo" type="button" value="報價" onclick="location.href='<%= request.getContextPath() %>/backend/tod/addTod.jsp?trino=${triVO.trino}&whichPage=<%= whichPage %>'">
	              </td>
	              <td>
