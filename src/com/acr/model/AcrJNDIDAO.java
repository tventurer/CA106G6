...
public class AcrJNDIDAO implements AcrDAO_interface{
	...
	// 一個應用程式終，針對一個資料庫，共用一個DataSource即可
		...
		try {
			...
			pstmt.setTimestamp(2, acrVO.getAcrtime());
			pstmt.setInt(3, acrVO.getAcrprice());
			pstmt.setInt(4, acrVO.getAcrsource());
			pstmt.setString(5, acrVO.getAcrend());
			pstmt.setInt(6, acrVO.getAcrtotal());
