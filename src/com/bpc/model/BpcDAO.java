...
public class BpcDAO implements BpcDAO_interface {
	...
	private static String GET_ONE_STMT = 
			"SELECT POSNO, MEMNO, TAGNO, POSTITLE, POSCONTENT, to_char(POSTIME,'yyyy-mm-dd') POSTIME FROM BLOGPOSTCOMMENT WHERE POSNO = ?";
	private static String GET_ALL_STMT = 
			"SELECT POSNO, MEMNO, TAGNO, POSTITLE, POSCONTENT, to_char(POSTIME,'yyyy-mm-dd') POSTIME FROM BLOGPOSTCOMMENT ORDER BY POSNO";
	static {
		try {
